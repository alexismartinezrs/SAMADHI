...
$(document).ready(function () {
    ...
    $("#add-to-cal").html(r), $("#rsvp-form").on("submit", function (e) {
        ...
        $("#alert-wrapper").html(
            ...
            $.post("https://script.google.com/macros/s/AKfycbwdG55S8eNJdFeBhzXWX5Z1iB7v3bF2L0XRgeDZIo7TSY3AgA1ROd-Q3C4-kqpP7jyd/exec", t).done(function (e) {
                if ("error" == e.result) {
                    $("#alert-wrapper").html(alert_markup("danger", e.message));
                }
                else {
                    $("#alert-wrapper").html(""), $("#rsvp-modal").modal("show")
                    $('#btnConfirmar').hide();
